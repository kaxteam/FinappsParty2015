...
public class RunningFragment extends Fragment {
    ...
    private class BackgroundData extends AsyncTask<Void, Void, Orientation> {

        @Override
        protected Orientation doInBackground(Void... params) {
            ...
            return myService.getOrentation();
        }

        @Override
        protected void onPostExecute(Orientation result) {
